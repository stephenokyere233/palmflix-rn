...
export const movieDetails = `${api_url}/movie/${movieID}?api_key=${API_KEY}&language=en-US`;
export const tvDetails = `${api_url}/movie/${movieID}?api_key=${API_KEY}&language=en-US`;
